...
# 2026-09-26検証：0.3uVで実際に採用されたP50/N35/N95ピークのプロミネンスは
# 中央値1.4〜2.7uVで、閾値ギリギリ(0.3-0.4uV)のケースは1.4〜2.5%と少数。
# 閾値を0.1〜0.6uVで振った感度分析では、0.1〜0.35uVの範囲では検出結果の
# 変化が最大17件(1354件中)にとどまる一方、0.5uV以上では52件以上に急増し、
# 本物の小さなピークを取りこぼし始める。
